...
const light: DefaultTheme = {
    colors: {
        ...
        textYellowLight: 'rgb(248, 236, 155)',
        textYellowMedium: 'rgb(255, 225, 31)',
        textYellowDark: 'rgb(255, 194, 10)',
        textGreenLight: 'rgb(205, 240, 183)',
        textGreenDark: 'rgb(101, 164, 111)',
        error: 'rgb(204, 0, 0)',
    },
    fontSize: {
